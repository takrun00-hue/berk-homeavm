...
export const dictionary = {
  tr: {
    ...
    aboutText: "MY BRAND, şık ve konforlu evleriniz için özenle tasarlanmış mobilya takımları sunar.",
    contactTitle: "İletişim",
    formName: "Ad Soyad",
    formPhone: "Telefon",
    formMessage: "Mesajınız",
    formSubmit: "Gönder",
    footerText: "MY BRAND, şık ve konforlu evleriniz için özenle tasarlanmış mobilya takımları sunar.",
  ...
  en: {
    ...
    aboutTitle: "About Us",
    aboutText: "MY BRAND offers furniture sets carefully designed for your stylish and comfortable homes.",
    contactTitle: "Contact",
    formName: "Full Name",
    formPhone: "Phone",
    formMessage: "Your Message",
    formSubmit: "Send",
    footerText: "MY BRAND offers furniture sets carefully designed for your stylish and comfortable homes.",
